...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            using (ApplicationDbContext Cadv = new ApplicationDbContext())
            { 
                List<City> city = Cadv.City.ToList<City>();
                SelectList sel = new SelectList(city, "CityId", "CityName");
                ViewBag.sel = sel;
                List<Governrate> government = Cadv.Governrate.ToList<Governrate>();
